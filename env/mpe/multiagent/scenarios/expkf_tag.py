...
def create_kalman_filter(): # , dt, process_noise, measurement_noise, initial_state_covariance
...
class Scenario(BaseScenario):
    ...
    def benchmark_data(self, agent, world):
        ...
        # ret = [[] for _ in range(len(world.agents))]
        # for adversary in self.adversaries(world):
        #     for good_agent in self.good_agents(world):
        #         ret[adversary.id].append(adversary.state.p_pos - good_agent.state.p_pos)
        #         ret[good_agent.id].append(good_agent.state.p_pos - adversary.state.p_pos)
        return ret
